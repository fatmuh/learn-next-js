  ...
  export default async function ProductPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col justify-center">
        <h1 className="text-center text-2xl font-bold my-4">Product Page</h1>
        <div className="relative m-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mx-auto justify-center">
          {products.length > 0 &&
